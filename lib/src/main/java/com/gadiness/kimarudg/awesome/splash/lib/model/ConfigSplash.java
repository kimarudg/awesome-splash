package com.gadiness.kimarudg.awesome.splash.lib.model;

import com.daimajia.androidanimations.library.Techniques;
import com.gadiness.kimarudg.awesome.splash.lib.R;
import com.gadiness.kimarudg.awesome.splash.lib.cnst.Defaults;
...
public class ConfigSplash implements Serializable {
    ...
    //SubTitle
    private String subTitleSplash;
    private String subTitleFont;
    private int animSubTitleDuration;
    private Techniques animSubTitleTechnique;
    ...
    public String getSubTitleSplash() {
        return subTitleSplash;
    }

    public void setSubTitleSplash(String subTitleSplash) {
        this.subTitleSplash = subTitleSplash;
    }
    ...
    public int getAnimSubTitleDuration() {
        return animSubTitleDuration;
    }

    public void setAnimSubTitleDuration(int animSubTitleDuration) {
        this.animSubTitleDuration = animSubTitleDuration;
    }

    public Techniques getAnimSubTitleTechnique() {
        return animSubTitleTechnique;
    }

    public void setAnimSubTitleTechnique(Techniques animSubTitleTechnique) {
        this.animSubTitleTechnique = animSubTitleTechnique;
    }
    ...
    public void initDefaults() {
        ...
        this.subTitleTextColor = android.R.color.white;
        this.subTitleFont = Defaults.EMPTY;
