package com.gadiness.kimarudg.awesome.splash.lib.activity;
...
abstract public class AwesomeSplash extends AppCompatActivity {
    ...
    public void startSubTitleTextAnimation() {

        mTxtSubTitle.setText(mConfigSplash.getSubTitleSplash());
        mTxtSubTitle.setTextSize(mConfigSplash.getSubTitleTextSize());
        mTxtSubTitle.setTextColor(getResources().getColor(mConfigSplash.getSubTitleTextColor()));
        if (!mConfigSplash.getSubTitleFont().isEmpty())
            setSubTitleFont(mConfigSplash.getSubTitleFont());

        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
                RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        params.addRule(RelativeLayout.BELOW, R.id.txtTitle);
        params.addRule(RelativeLayout.CENTER_HORIZONTAL);
        mTxtSubTitle.setLayoutParams(params);
        mTxtSubTitle.setVisibility(View.VISIBLE);

        YoYo.with(mConfigSplash.getAnimSubTitleTechnique()).withListener(new Animator.AnimatorListener() {
            @Override
            public void onAnimationStart(Animator animation) {
            }
